...
<main>
    ...
    <section class="menu">
        <nav class="menuNav">
            ...
            <a class="active" href="<?= '/ucet/' . $uzivatel->id . '/komentare' ?>">Komentáře uživatele</a>
        ...
        <div class="subPanel">
            ...
            ?>
                        ...
                        <article class="article">
                            <p class="komentarObsah"><?= $komentar->obsah ?></p>
                            <div class="articleVedle">
                                ...
                                <div class="textClanek flex2">
                                    <div>
                                        <div class="clanek">
                                            <a href="/clanek/<?= $komentar->idClanek ?>">
